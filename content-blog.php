...
?>
<li><?php print $blog_post->post_title;?></li>
</ul>
</div>
</div>
...
<li class="current"><a href="<?php echo get_permalink(get_option('page_for_posts')); ?>">All News</a></li>
<?php
...
$arr_term_dop=array();
	...
	if (count($arr_term)>0)
	{
		...
		?>
		<li><a href="<?php print get_term_link($block['id']);?>"><?php print $block['title'];?></a></li>
		<?php 
		endforeach;
	} 
